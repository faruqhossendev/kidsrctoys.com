...
const Nav = ({keyword, keywordChangeHandlar}) => {
    ...
    useEffect(() => {
        const menuURL = 'https://hometoos.com/kidsrctoys/wp-json/menus/v1/menus/mainMenu'
        Axios.get(menuURL)
            .then(res => {
    ...
    useEffect(() => {
        const catatoryURL = 'https://hometoos.com/kidsrctoys/wp-json/wp/v2/categories'
    ...
    useEffect(() => {
        const pageURL = 'https://hometoos.com/kidsrctoys/wp-json/wp/v2/pages'
        Axios.get(pageURL)
            .then((res) => {
                setPages(res.data)
            })
